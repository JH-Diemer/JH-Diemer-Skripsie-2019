...
for k in range(150): #loop for training runs   
                      ...
                      <AgentSection mode="Survival">
                        ...
                        <AgentHandlers>
                          ...
                          <RewardForTouchingBlockType>
                            ...
                            <Block reward="10" type="lapis_block"/>
                          </RewardForTouchingBlockType>
    ...
    my_clients.add(MalmoPython.ClientInfo('127.0.0.1', 10004)) # add Minecraft machines here as available
    agentID = 0
    expID = 'tabular_SARSA'
...
#    root.update()
    ...
    path = "/home/skripsie/Work/CSVFiles/CliffWalking_SARSA_coord_%d.csv" % k
    file = open(path, 'w')
