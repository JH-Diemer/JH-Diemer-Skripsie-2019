...
for k in range(150): #loop for training runs 
    ...
    my_clients.add(MalmoPython.ClientInfo('127.0.0.1', 10003)) # add Minecraft machines here as available
    agentID = 0
...
#    root.update()
    ...
    path = "/home/skripsie/Work/CSVFiles/CliffWalking_Double-Q-learning_grid_%d.csv" % k
    file = open(path, 'w')
